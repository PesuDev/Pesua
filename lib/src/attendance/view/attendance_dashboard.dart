...
fontFamily: 'open sans',
                                        ...
                                        SizedBox(width: 30,),
                                        Expanded(child: Text(value.attendanceListModel?.aTTENDANCELIST?[index].attendedClasses == 0 || value.attendanceListModel?.aTTENDANCELIST?[index].attendedClasses == null ? "NA" : "${value.attendanceListModel?.aTTENDANCELIST?[index].attendedClasses?.toDouble().toInt()??0}/${value.attendanceListModel?.aTTENDANCELIST?[index].totalClasses??0}")),
                                        SizedBox(width: 15,),
                                        Expanded(child: Text("${value.attendanceListModel?.aTTENDANCELIST?[index].attendancePercenrage?.toDouble().toInt()??"NA"}")),
                                        SizedBox(width: 5,),
                                        Expanded(child: IconButton(
                                          ...
                                          onPressed: ()async{
                                            ...
                                            Navigator.pushNamed(context, AppRoutes.detailedAttendance,arguments: DetailedArguments(
                                              ...
                                              attendance: "${value.attendanceListModel?.aTTENDANCELIST?[index].attendedClasses?.toDouble().toInt()}/${value.attendanceListModel?.aTTENDANCELIST?[index].totalClasses}",
                                              percentage: value.attendanceListModel?.aTTENDANCELIST?[index].attendancePercenrage?.toDouble().toInt().toString(),
