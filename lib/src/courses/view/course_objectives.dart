...
class CourseObjectives extends StatefulWidget {
  int? subjectCode;
  String subjectName;
  int? ccId;
 CourseObjectives({this.ccId,required this.subjectName,this.subjectCode});


  @override
  State<CourseObjectives> createState() => _CourseObjectivesState();
}

class _CourseObjectivesState extends State<CourseObjectives> {
