...
class _SessionEffectState extends State<SessionEffect> {
  ...
  void initState() {
    super.initState();
    sessionEffectivenessViewmodel =
        Provider.of<SessionEffectivenessViewmodel>(context, listen: false);
    sessionEffectivenessViewmodel!.getSessionDetail(
        action: 39,
        mode: 4,
        userId: 'bac97ff1-1c7e-4a64-b225-cdb77839a9c0',
        randomNum: 0.17770127727820895,
        dayNumber: 3);
    sessionEffectivenessViewmodel!.feedbackDetails(
        timeTableTemplateDetailsId: '2c9d24fd-a1bc-11e7-8ecc-79e925fb7f88',
        BatchId: 26,
        mode: 2,
        subjectCode: 'UM21MB651B',
        action: 39,
        BatchClassId: 1498,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Consumer<SessionEffectivenessViewmodel>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                            value: data.sessionEffectivenessModel
                                ?.timetableList?[0].subjectName,
                            items: data.items
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                  "Please provide Session Effectiveness Feedback Below"),
                              SizedBox(
                                height: 10,
                              ),
                              Row(
                            ...
                            onPressed: () async {
                              await sessionEffectivenessViewmodel!.feedbackDetails(
                                  timeTableTemplateDetailsId: data
                                      ...
                                      '',
                                  BatchId:
                                      data.sessionEffectivenessModel?.subjectlist?[0].batchId ??
                                          0,
                                  mode: 2,
                                  subjectCode: data.sessionEffectivenessModel
                                          ?.subjectlist?[0].subjectCode ??
                                      '',
                                  action: 39,
                                  BatchClassId: data.sessionEffectivenessModel
                                          ?.subjectlist?[0].batchClassId ??
                                      0,
                                  isLocallySavedData: 'FALSE',
                        ...
                        Text(
                          "Please mark the area on the grid that accurately reflects today's session.",
                        ...
                        Text(
                          "Session Effectiveness vs Learning Effectiveness",
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
                        SizedBox(
                          height: 5,
                        ...
                        RichText(
                          ...
                          TextSpan(
                            text:
                                "Low Session Effectiveness and Low Learning (Ineffective Teaching, Hard Concepts).",
                            style: TextStyle(
                        ...
                        RichText(
                          ...
                          TextSpan(
                            text:
                                "High Session Effectiveness and Low Learning (Low Attention Span, Non Interesting Subject, Fatigue, Tough Concepts).",
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Colors.black),
                          ),
                        ...
                        RichText(
                          ...
                          TextSpan(
                            text:
                                "Low Session Effectiveness and High Learning (Self Learning, Peer based Learning, Books, Media).",
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Colors.black),
                          ),
                        ...
                        RichText(
                          ...
                          TextSpan(
                            text:
                                "High Session Effectiveness and High Learning (Elevated Teaching Quality, Creative Methodologies, Great Learning Experience, Interesting and Relevant Subject).",
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Colors.black),
                          ),
